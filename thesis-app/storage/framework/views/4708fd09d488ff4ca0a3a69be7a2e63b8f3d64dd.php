        ...
        <aside
            ...
            <div class="max-w-xl my-auto">
                <a href="/" class="inline-flex items-center gap-3">
                    <img src="<?php echo e(asset('images/WHITE SMALL LOCATOR.png')); ?>" 
                    alt="Logo" 
        ...
        <main class="flex-1 grid place-items-center p-6">
            <div class="w-full max-w-md">
                <div class="mb-8 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="ml-auto text-sm text-brand-700 hover:text-brand-800">Create
                        account</a>
                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="text-xs text-gray-500 hover:text-brand-700">Need an
                                account?</a>
                        </div>
...
</html><?php /**PATH C:\Users\Marc\Documents\GitHub\THESIS-FILES\thesis-app\resources\views/auth/login.blade.php ENDPATH**/ ?>