  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="p-[2px] rounded-2xl bg-gradient-to-r from-pink-500 to-purple-600 mb-6">
      <div class="bg-white rounded-2xl p-6 shadow-xl">
        <h1 class="text-3xl font-extrabold text-brand-800">🧾 Pending User Approvals</h1>
        <p class="text-gray-600 mt-1">Review sign-ups and assign a role.</p>
      </div>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50/80">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-[11px] tracking-wide font-semibold text-gray-500 uppercase">Action</th>
            </tr>
          </thead>
                  ...
                  <div class="flex flex-wrap gap-2">
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if(!$user->hasRole($role->name)): ?>
                        <form action="<?php echo e(route('admin.approveUser', ['id' => $user->id, 'role' => $role->name])); ?>" method="POST">
                          <?php echo csrf_field(); ?>
                          <button type="submit"
                            class="text-xs rounded-lg bg-gradient-to-r from-brand-500 to-indigo-600 text-white px-3 py-1 shadow hover:shadow-md">
                            Approve as <?php echo e(ucfirst($role->name)); ?>
                    ...
                    <form action="<?php echo e(route('admin.denyUser', $user->id)); ?>" method="POST"
                          onsubmit="return confirm('Deny this user?');">
                      <?php echo csrf_field(); ?>
                      <?php echo method_field('PATCH'); ?>
                      <button type="submit"
                        class="text-xs rounded-lg bg-red-500 hover:bg-red-600 text-white px-3 py-1">
                        Deny
                      </button>
                    </form>
                  </div>
...
<?php /**PATH C:\Users\Marc\Documents\GitHub\THESIS-FILES\thesis-app\resources\views/admin/users.blade.php ENDPATH**/ ?>