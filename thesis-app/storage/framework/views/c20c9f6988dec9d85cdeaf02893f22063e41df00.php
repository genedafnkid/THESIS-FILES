    ...
    <section class="p-[2px] rounded-2xl bg-gradient-to-r from-pink-400 to-purple-500">
      <div class="bg-white rounded-2xl p-6 sm:p-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <!-- Game 1 -->
          <div class="group">
            <a href="<?php echo e(url('/play1')); ?>" class="block aspect-video rounded-2xl overflow-hidden shadow hover:shadow-lg transition">
              <img src="<?php echo e(asset('storage/thumbnail-1.png')); ?>" alt="Conflict Resolution"
          ...
          <!-- Game 2 -->
          <div class="group">
            <a href="<?php echo e(url('/play2')); ?>" class="block aspect-video rounded-2xl overflow-hidden shadow hover:shadow-lg transition">
              <img src="<?php echo e(asset('storage/thumbnail-2.png')); ?>" alt="Integrity at Work"
                   class="w-full h-full object-cover group-hover:scale-105 duration-300">
            </a>
          ...
          <div class="group relative">
            <a href="#" class="block aspect-video rounded-2xl overflow-hidden shadow opacity-70 pointer-events-none">
              <img src="<?php echo e(asset('storage/thumbnail-2.png')); ?>" alt="Coming Soon" class="w-full h-full object-cover">
            </a>
...
<?php /**PATH C:\Users\Marc\Documents\GitHub\THESIS-FILES\thesis-app\resources\views/faith-room.blade.php ENDPATH**/ ?>