    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        ...
        <div class="flex items-center gap-3">
          <a href="{{ route('login') }}" class="hidden sm:inline-flex px-4 py-2 rounded-xl border border-gray-200 hover:border-brand-400/60 hover:text-brand-800">Log in</a>
          <a href="{{ route('register') }}" class="inline-flex px-4 py-2 rounded-xl bg-gradient-to-r from-brand-500 to-indigo-600 text-white shadow-glow hover:shadow-lg">Get started</a>
        </div>
      </div>
    </div>
  </header>
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div class="mt-8 flex flex-wrap items-center gap-3">
            ...
            <a href="{{ route('community') }}" class="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-white ring-1 ring-gray-200 hover:ring-brand-400/60">
              Join Community
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div class="mt-10 flex flex-wrap gap-3">
            <a href="{{ route('register') }}" class="inline-flex px-5 py-3 rounded-2xl bg-gradient-to-r from-brand-500 to-indigo-600 text-white shadow-glow">Create account</a>
