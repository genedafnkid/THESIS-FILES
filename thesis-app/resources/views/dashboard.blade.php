...
@section('content')
        ...
        <main class="flex-1 p-6">
            ...
            <div class="p-[2px] rounded-xl bg-gradient-to-r from-pink-500 to-purple-600">
                <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <ul class="space-y-2">
                        <li class="bg-gray-50 p-4 rounded shadow text-gray-700">🗓️ Quiz on “Biblical Covenants” is due
                            Friday.</li>
                        <li class="bg-gray-50 p-4 rounded shadow text-gray-700">🙏 Virtual Prayer Night on Wednesday @ 7 PM.
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <script>
        fetch("/user", {
            ...
            .then(r => r.json())
            .then(data => console.log("✅ Current user ID:", data.id))
